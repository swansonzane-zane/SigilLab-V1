    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-start">
        <section className="space-y-3">
          ...
          <section
            id={`seal-poster-${model.shareId}`}
            className="relative aspect-[4/5] overflow-hidden rounded-[1.5rem] border border-[#80623c]/30 bg-[radial-gradient(circle_at_top,_rgba(176,141,87,0.18),_transparent_30%),radial-gradient(circle_at_22%_16%,_rgba(122,31,23,0.26),_transparent_26%),linear-gradient(180deg,#17100c,#080605)] p-5 shadow-[0_30px_120px_rgba(0,0,0,0.58)] sm:p-6"
          >
            <div
              aria-hidden="true"
              className="absolute inset-0 opacity-75 [background-image:radial-gradient(rgba(214,188,132,0.11)_1px,transparent_1px),linear-gradient(115deg,rgba(122,31,23,0.22),transparent_34%,rgba(176,141,87,0.09)_72%,transparent)] [background-size:12px_12px,100%_100%]"
            />
            <div
              aria-hidden="true"
              className="absolute inset-4 border border-[#b08d57]/16"
            />
            <div className="relative flex h-full flex-col">
              <div className="flex items-start justify-between gap-3">
                ...
                <p className="max-w-[8rem] text-right text-[11px] tracking-[0.14em] text-[#bba16e]/68">
                  {model.posterEyebrow}
                </p>
              </div>
              ...
              <div className="mt-4 space-y-2 text-center">
                ...
                <h2 className="mx-auto max-w-[22rem] font-heading text-[1.55rem] leading-[1.2] font-semibold text-[#f2dfb8] sm:max-w-[24rem] sm:text-[1.95rem]">
                  {model.ritualPhrase || model.headline}
                </h2>
                <p className="mx-auto max-w-sm text-sm leading-7 text-[#e5d0a2]/86">
                  {model.intentLine}
                </p>
                <p className="text-[12px] tracking-[0.18em] text-[#d9c7a1]/72 uppercase">
                  {model.siteHost}
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative space-y-6">
              ...
              <div className="space-y-4 text-center">
                ...
                <p className="text-lg leading-8 text-[#d8c7a4]/88">
                  {model.headline}
                </p>
