      ...
      <div className="relative mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-5 py-10 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <button
            ...
            className="inline-flex min-h-12 items-center justify-center rounded-sm bg-[linear-gradient(135deg,#9d2b20,#6f1711_54%,#2a1711)] px-6 text-sm font-semibold text-[#fff4d6] transition hover:brightness-110"
          >
            Try Again
          </button>
          <Link
